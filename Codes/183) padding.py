...
for i in range(len(l)):
    ...
    cur_label.grid(row=i,column=0,sticky=tk.W,padx=20,pady=20)
...
for i in user_info:
    ...
    curr_entry.grid(row=counter,column=1,sticky=tk.W,padx=20,pady=20) # padx will create spaces in left and right whereas pady will
    # create spaces in top and bottom 
    counter+=1
...
submit_btn.grid(row=counter,column=0,sticky=tk.W,padx=20,pady=20)
win.mainloop()